...
[Migration(3)]
public class M3_Functions: Migration
{
    ...
    {
        Execute.Sql("""
            drop function get_by_client("SearchClientId" int, "SearchCpId" int default 0);
        """);
        Execute.Sql("""
            drop function get_by_cp("SearchCpId" int, "SearchClientId" int default 0);
        """);
    }
}